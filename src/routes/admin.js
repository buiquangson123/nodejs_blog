...
router.post('/courses/handle-action-form-trash', courseControllers.handleActionFormTrash); //Khôi phục và xóa vĩnh viễn khóa học ở thùng rác
...
router.delete('/courses/:id/force', courseControllers.forceDelete); //Xóa vĩnh viễn một khóa học ở thùng rác
...
router.post('/acounts/store', acountControllers.storeAcount);   //post người dùng mới thêm
...
router.get('/home',verifyToken, siteControllers.homeAdmin);
